        ...
        <div className="row g-4">
          ...
          <div className="col-12 col-md-6">
            <AnimatedContent distance={30} delay={0.15}>
              <SpotlightCard className="finanza-card h-100 p-4 border-0 shadow-sm" spotlightColor="rgba(53, 94, 252, 0.15)">
                ...
                <form onSubmit={handleUpdateInfo}>
                  ...
                  <StarBorder className="w-100">
                    <button
                      ...
                      className="btn btn-finanza-primary w-100 py-2.5 font-jost fw-semibold d-flex align-items-center justify-content-center gap-2 border-0"
                    >
                      {infoLoading ? (
          ...
          <div className="col-12 col-md-6">
            <AnimatedContent distance={30} delay={0.25}>
              <SpotlightCard className="finanza-card h-100 p-4 border-0 shadow-sm" spotlightColor="rgba(233, 60, 5, 0.15)">
                <div className="pb-3 mb-3 border-bottom">
                  <h3 className="h6 mb-0 fw-bold text-dark font-jost">
