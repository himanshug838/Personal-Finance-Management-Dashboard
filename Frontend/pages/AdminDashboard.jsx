...
const AdminDashboard = () => {
  ...
  const handleToggleRole = async (targetUser) => {
    ...
    try {
      ...
      if (newRole === 'admin') {
        setSuccessMsg(
          `User ${targetUser.firstName} ${targetUser.lastName} (${targetUser.email}) has been successfully PROMOTED to ADMIN! Once this user logs in or refreshes status, the Admin Portal will be accessible to them.`
        );
      } else {
      ...
      <div className="max-w-6xl mx-auto space-y-4">
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <div>
                <div className="d-flex align-items-center gap-2">
                  <h1 className="h4 fw-bold text-white mb-0 font-jost">Admin Control Center</h1>
                  <span className="finanza-pill-badge">SYSTEM ADMIN</span>
                </div>
        ...
        <div className="row g-3">
          ...
          <div className="col-12 col-sm-6 col-md-3">
            <div className="finanza-card p-3 d-flex align-items-center gap-3">
        ...
        <div className="finanza-card overflow-hidden">
